    ...
    <div class="wrapper vh-100">
      <div class="align-items-center h-100 d-flex w-50 mx-auto">
        <div class="mx-auto text-center">
          <h1 class="display-1 m-0 font-weight-bolder text-muted" style="font-size:80px;">삭제성공</h1>
          <h1 class="mb-1 text-muted font-weight-bold"></h1>
          <h6 class="mb-3 text-muted">2초 뒤 리스트로 이동합니다.</h6>
