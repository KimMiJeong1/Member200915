...
<html lang="en">
  ...
  <body class="light ">
    <div class="wrapper vh-100">
      <div class="align-items-center h-100 d-flex w-50 mx-auto">
        <div class="mx-auto text-center">
          <h1 class="display-1 m-0 font-weight-bolder text-muted" style="font-size:80px;">수정성공</h1>
          <h1 class="mb-1 text-muted font-weight-bold">WOW!</h1>
          <h6 class="mb-3 text-muted">${name}님, 2초 뒤 리스트로 이동합니다.</h6>
          <a href="list" class="btn btn-lg btn-primary px-5">리스트로 이동</a>
        </div>
      </div>
    </div>
    ...
    <script>
    setTimeout(function() {window.location='list';},2000);
	</script>
  </body>
</html>
</body>
